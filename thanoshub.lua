...
local megasussybackakeedlolprivateuser = deffentlyasupermanlol



if  megasussybackakeedlolprivateuser then


local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()

local Window = Library.CreateLib("thanos hub v2.1 PRIVATE", "Ocean")
